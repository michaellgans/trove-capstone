...
type AccountBalanceChildCardProps = {
    label: string;
    balance: string;
...
const AccountBalanceChildCard: React.FC<AccountBalanceChildCardProps> = ({
  label,
  balance,
  selectedCurrency,
  onCurrencyChange,
  ...
  return (
    <div className="mb-4 relative">
      ...
      <div className="relative flex items-center">
        ...
        <div
            className="w-full pl-8 pr-60 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-brightBlue focus:ring-opacity-50 cursor-default"
        >{balance}</div>
        {/* Currency Dropdown */}
...
export default AccountBalanceChildCard;
